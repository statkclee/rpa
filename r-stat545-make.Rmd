...
데이터 분석 자동화 전형적인 패턴을 따라 `Make` 자동화 개념을 이해하고, STAT545 데이터 분석 예제를 따라 자동화 과정을 실습한다.
...
# 전형적인 데이터 분석업무 작업흐름 {#stat545-workflow}
...
# STAT545 데이터 분석작업 자동화 [^stat545-make-lesson] {#stat545-make-ex}
...
# 보고서 생성 자동화 {#stat545-make-automation}

## 작업 정리 {#stat545-make-work-clean}
