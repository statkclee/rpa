...
subtitle: "GitHub Action: API KEY를 갖는 Rmd 프로그램 작성"
output:
  html_document:
    includes:
...
매 3시간 마다 보고서가 자동 생성되도록 한다.

[crontab guru](https://crontab.guru/every-2-hours) 웹사이트에서 관련 내용을 참조한다.
...
## GitHub 저장소에 저장된 WEATHER_API_KEY 호출
