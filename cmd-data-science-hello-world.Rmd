...
subtitle: "명령라인(Commandline) 인터페이스 - 데이터 과학"
author:
    name: xwMOOC
date: "`r Sys.Date()`"
output:
...
# 명령라인 인터페이스 강력함 시연 {#cmd-interface}

> **대표적 국내외 공유 저작물 저장소** [^public-domain] [^public-domain-summary]
>
...
# 명령라인 데이터 분석 [^cmd-data-analysis] [^data-science-toolbox] {#cmd-data-analysis}
...
## 데이터 가져오기 {#cmd-import-data-shell}
...
## 데이터 정제 {#cmd-clean-data}

### 행 뽑아내기 {#cmd-extract-rows}
